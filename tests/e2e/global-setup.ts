...
export const TEST_REPO_PATH_FILE = path.join(os.tmpdir(), 'serper-e2e-test-repo-path.txt')
...
export default function globalSetup(): void {
  ...
  if (process.env.SERPER_E2E_SSH_LOCALHOST === '1') {
    // Why: the localhost SSH spec deploys Serper's relay from out/relay. The
