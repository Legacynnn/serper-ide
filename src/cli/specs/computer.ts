...
export const COMPUTER_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    usage:
      'serper computer list-windows --app <name|bundle|pid:N> [--worktree <selector> | --session <id>] [--json]',
  ...
  },
  {
    ...
    usage:
      'serper computer get-app-state --app <name|bundle|pid:N> [--window-id <id> | --window-index <n>] [--worktree <selector> | --session <id>] [--restore-window] [--no-screenshot] [--json]',
  ...
  },
  {
    ...
    usage:
      'serper computer click --app <app> (--element-index <n> | --x <x> --y <y>) [--window-id <id> | --window-index <n>] [--click-count <n>] [--mouse-button <left|right|middle>] [--restore-window] [--no-screenshot] [--json]',
    allowedFlags: [
  ...
  },
  {
    ...
    usage:
      'serper computer perform-secondary-action --app <app> --element-index <n> --action <name> [--window-id <id> | --window-index <n>] [--restore-window] [--no-screenshot] [--json]',
  ...
  },
  {
    ...
    usage:
      'serper computer scroll --app <app> (--element-index <n> | --x <x> --y <y>) --direction <up|down|left|right> [--window-id <id> | --window-index <n>] [--pages <n>] [--restore-window] [--no-screenshot] [--json]',
  ...
  },
  {
    ...
    usage:
      'serper computer drag --app <app> (--from-element-index <n> --to-element-index <n> | --from-x <x> --from-y <y> --to-x <x> --to-y <y>) [--window-id <id> | --window-index <n>] [--restore-window] [--no-screenshot] [--json]',
    allowedFlags: [
      ...COMPUTER_ACTION_FLAGS,
      'from-element-index',
      'to-element-index',
  ...
  },
  {
    ...
    usage:
      'serper computer type-text --app <app> (--text <text> | --text-stdin) [--window-id <id> | --window-index <n>] [--restore-window] [--no-screenshot] [--json]',
  ...
  },
  {
    ...
    usage:
      'serper computer press-key --app <app> --key <key> [--window-id <id> | --window-index <n>] [--restore-window] [--no-screenshot] [--json]',
  ...
  },
  {
    ...
    usage:
      'serper computer hotkey --app <app> --key <key-combo> [--window-id <id> | --window-index <n>] [--restore-window] [--no-screenshot] [--json]',
    allowedFlags: [...COMPUTER_ACTION_FLAGS, 'key']
  },
  {
    ...
    usage:
      'serper computer paste-text --app <app> (--text <text> | --text-stdin) [--window-id <id> | --window-index <n>] [--restore-window] [--no-screenshot] [--json]',
    allowedFlags: [...COMPUTER_ACTION_FLAGS, 'text', 'text-stdin']
  },
  {
    ...
    usage:
      'serper computer set-value --app <app> --element-index <n> (--value <text> | --value-stdin) [--window-id <id> | --window-index <n>] [--restore-window] [--no-screenshot] [--json]',
