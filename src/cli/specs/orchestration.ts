...
export const ORCHESTRATION_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    usage:
      'serper orchestration send --to <handle> --subject <text> [--from <handle>] [--body <text>] [--type <type>] [--priority <level>] [--thread-id <id>] [--payload <json>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'to',
      'from',
  ...
  },
  {
    ...
    usage:
      'serper orchestration check [--terminal <handle>] [--unread | --all] [--types <type,...>] [--inject] [--wait] [--timeout-ms <n>] [--json]\n' +
  ...
  },
  {
    ...
    usage: 'serper orchestration reply --id <msg_id> --body <text> [--from <handle>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'id', 'body', 'from']
  },
  {
    path: ['orchestration', 'inbox'],
    summary: 'Show messages across (or for) recipients',
    usage: 'serper orchestration inbox [--limit <n>] [--terminal <handle>] [--full] [--json]',
  ...
  },
  {
    ...
    usage: 'serper orchestration task-list [--status <status>] [--ready] [--json]',
  ...
  },
  {
    ...
    usage:
      'serper orchestration dispatch --task <task_id> --to <handle> [--from <handle>] [--inject] [--dry-run] [--return-preamble] [--json]',
  ...
  },
  {
    ...
    usage:
      'serper orchestration dispatch-show --task <task_id> [--preamble] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage:
      'serper orchestration ask --to <handle> --question <text> [--options <csv>] [--timeout-ms <n>] [--from <handle>] [--json]',
  ...
  },
  {
    ...
    usage: 'serper orchestration run-stop [--json]',
  ...
  },
  {
    ...
    usage: 'serper orchestration gate-resolve --id <gate_id> --resolution <text> [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'id', 'resolution']
  },
  {
    path: ['orchestration', 'gate-list'],
    summary: 'List decision gates',
    usage: 'serper orchestration gate-list [--task <task_id>] [--status <status>] [--json]',
    allowedFlags: [...GLOBAL_FLAGS, 'task', 'status']
  },
  {
    path: ['orchestration', 'reset'],
    summary: 'Reset orchestration state',
    usage: 'serper orchestration reset [--all] [--tasks] [--messages] [--json]',
