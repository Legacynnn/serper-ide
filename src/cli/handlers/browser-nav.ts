...
// round-trip, even when Serper is healthy. Give browser.wait an explicit timeout
// budget so slow waits do not get mislabeled as "Serper is not running" by the
