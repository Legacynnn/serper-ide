...
// through Serper. Without a cap, a heavily-used instance accumulates thousands of
...
// after configureDevUserDataPath() but before app.setName('Serper'). See the
...
export function initStatsPath(): void {
  _statsFile = join(app.getPath('userData'), 'serper-stats.json')
}
