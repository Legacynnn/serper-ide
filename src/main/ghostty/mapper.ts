...
export function mapGhosttyToSerper(
  ...
  const FIELD_PARSERS: Record<string, FieldParser> = {
    ...
    'focus-follows-mouse': (v) => {
      // Why: Ghostty's focus-follows-mouse is semantically identical to Serper's
  ...
  for (const [key, rawValue] of Object.entries(parsed)) {
    ...
    // Why: Serper's windowBackgroundBlur is a boolean; the numeric radius is lost.
