...
const ATOM_FEED_URL = 'https://github.com/Legacynnn/serper/releases.atom'
const RELEASES_DOWNLOAD_BASE = 'https://github.com/Legacynnn/serper/releases/download'
...
const TAG_HREF_RE = /href="https:\/\/github\.com\/Legacynnn\/serper\/releases\/tag\/([^"]+)"/g
