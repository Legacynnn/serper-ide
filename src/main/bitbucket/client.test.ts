...
describe('Bitbucket client', () => {
  beforeEach(() => {
    process.env = { ...OLD_ENV }
    process.env.SERPER_BITBUCKET_API_BASE_URL = 'https://api.test.local/2.0'
    process.env.SERPER_BITBUCKET_EMAIL = 'user@example.com'
    process.env.SERPER_BITBUCKET_API_TOKEN = 'token'
    delete process.env.SERPER_BITBUCKET_ACCESS_TOKEN
