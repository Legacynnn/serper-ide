...
function getAuthConfig(): BitbucketAuthConfig {
  return {
    baseUrl: envValue('SERPER_BITBUCKET_API_BASE_URL') ?? DEFAULT_API_BASE_URL,
    accessToken: envValue('SERPER_BITBUCKET_ACCESS_TOKEN'),
    email: envValue('SERPER_BITBUCKET_EMAIL'),
    apiToken: envValue('SERPER_BITBUCKET_API_TOKEN')
  }
}
