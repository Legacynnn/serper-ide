...
describe('wsl path helpers', () => {
  ...
  it('converts Windows drive paths to /mnt paths for WSL commands', () => {
    expect(toLinuxPath('C:\\Users\\jinwo\\git\\serper')).toBe('/mnt/c/Users/jinwo/git/serper')
  })

  it('converts /mnt drive paths back to native Windows form', () => {
    expect(toWindowsWslPath('/mnt/c/Users/jinwo/git/serper', 'Ubuntu')).toBe(
      'C:\\Users\\jinwo\\git\\serper'
    )
  })
})
