...
// Why: the WebSocket transport enables mobile clients to connect to the Serper
...
// tokens (validated by the message handler in SerperRuntimeRpcServer) provide auth
...
export class WebSocketTransport implements RpcTransport {
  ...
  async start(): Promise<void> {
    ...
    // Why: when the preferred port is occupied (e.g. another Serper instance is
  ...
  // and dispatch logic to the message handler set by SerperRuntimeRpcServer.
