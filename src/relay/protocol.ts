...
export type HandshakeMessage =
  | { type: 'serper-relay-handshake'; version: string }
  | { type: 'serper-relay-handshake-ok'; version: string }
  | { type: 'serper-relay-handshake-mismatch'; expected: string; got: string }
...
export function parseHandshakeMessage(payload: Buffer): HandshakeMessage {
  ...
  if (
    t !== 'serper-relay-handshake' &&
    t !== 'serper-relay-handshake-ok' &&
    t !== 'serper-relay-handshake-mismatch'
  ) {
