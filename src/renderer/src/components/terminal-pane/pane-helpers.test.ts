...
describe('shellEscapePath', () => {
  ...
  it('keeps safe Windows paths unquoted', () => {
    expect(shellEscapePath('C:\\Users\\serper\\file.txt', 'windows')).toBe(
      'C:\\Users\\serper\\file.txt'
    )
  })

  it('double-quotes Windows paths with spaces', () => {
    expect(shellEscapePath('C:\\Users\\serper\\my file.txt', 'windows')).toBe(
      '"C:\\Users\\serper\\my file.txt"'
    )
  })

  it('double-quotes Windows paths with cmd separators', () => {
    expect(shellEscapePath('C:\\Users\\serper\\a&b.txt', 'windows')).toBe(
      '"C:\\Users\\serper\\a&b.txt"'
    )
  })
  ...
  it('uses POSIX escaping for SSH drops regardless of client OS', () => {
    ...
    expect(shellEscapePath("/home/u/wt/.serper/drops/my file's $draft.txt", 'posix')).toBe(
      "'/home/u/wt/.serper/drops/my file'\\''s $draft.txt'"
    )
  })
})
