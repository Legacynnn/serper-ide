      ...
      <section key="claude-accounts" id="accounts-claude" className="space-y-4 scroll-mt-6">
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            Optional. Serper can use your normal Claude login; add accounts only if you want quick
        ...
        >
          <div className="flex items-center justify-between gap-3">
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-muted-foreground">
                Serper swaps Claude auth only; config and chat history stay in the shared Claude
                root.
              </p>
            </div>
            <Button
          ...
          <div className="space-y-2">
            ...
            {claudeAccounts.accounts.length === 0 ? (
              <div className="rounded-md border border-dashed border-border/70 px-3 py-4 text-xs text-muted-foreground">
                No managed Claude accounts yet. Serper will use your system default Claude login
    ...
    matchesSettingsSearch(searchQuery, ACCOUNTS_CODEX_SEARCH_ENTRIES) ? (
      <section key="codex-accounts" id="accounts-codex" className="space-y-4 scroll-mt-6">
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            Optional. Serper can use your normal Codex login; add accounts only if you want quick
            switching in Serper.
          </p>
          <p className="text-xs text-muted-foreground">
            Each account keeps its own local sign-in context in Serper. Account auth stays on this
            device.
          </p>
        </div>
        ...
        <SearchableSetting
          ...
          description="Manage which Codex account Serper uses for live rate limit fetching."
        ...
        >
          ...
          <div className="flex items-center justify-between gap-3">
            <div className="space-y-0.5">
              <Label>Accounts</Label>
              <p className="text-xs text-muted-foreground">
                Add a Codex account to use it in Serper.
              </p>
            </div>
            <Button
              variant="outline"
          ...
          {codexAccounts.accounts.length === 0 ? (
            <div className="rounded-md border border-dashed border-border/70 px-3 py-4 text-xs text-muted-foreground">
              No managed Codex accounts yet. Serper will use your system default Codex login until
              you add one here.
            </div>
          ) : (
            <div className="space-y-2">
    ...
    matchesSettingsSearch(searchQuery, ACCOUNTS_GEMINI_SEARCH_ENTRIES) ? (
      <section key="gemini" id="accounts-gemini" className="space-y-4 scroll-mt-6">
        ...
        <SearchableSetting
          ...
          description="Extracts OAuth credentials from your local Gemini CLI installation to authenticate with Google. This uses credentials issued to the Gemini CLI app, not Serper. May break if Google updates the CLI. Use at your own risk."
          keywords={[
            'gemini',
            'cli',
            'oauth',
        ...
        >
          <div className="space-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">
              ...
              with Google. This uses credentials issued to the Gemini CLI app, not Serper. May break
      ...
      >
        <DialogContent showCloseButton={false}>
          <DialogHeader>
            ...
            <DialogDescription>
              Serper will delete the managed Codex home for this saved account. If it is currently
              active, Serper falls back to the system default Codex login.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
      ...
      >
        <DialogContent showCloseButton={false}>
          <DialogHeader>
            ...
            <DialogDescription>
              Serper will delete the managed Claude auth for this saved account. If it is currently
              active, Serper falls back to the system default Claude login.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
