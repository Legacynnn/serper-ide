...
const EXAMPLE_PROMPTS: string[] = [
  'Using Serper CLI, open https://github.com/notifications and click the first unread pull request.',
  "Take a screenshot of my open Linear board with the Serper CLI and tell me what's blocked.",
  'With Serper CLI, go to our staging app, log in (my cookies are imported), and verify the checkout flow works.'
]
