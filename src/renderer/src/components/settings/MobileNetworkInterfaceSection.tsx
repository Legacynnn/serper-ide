      ...
      <div className="space-y-3">
        <div className="flex flex-wrap items-center gap-3">
          ...
          {/* Why: VPN/tailnet interfaces can appear after this pane mounts.
              Re-enumerating OS state here avoids requiring an Serper restart. */}
          <Tooltip>
      ...
      <Accordion type="single" collapsible className="mt-4 border-t border-border/60 pt-2">
        <AccordionItem value="remote-pairing-guide">
          ...
          <AccordionContent className="space-y-3 text-xs text-muted-foreground">
            <p>
              Serper Mobile connects directly to this computer. To use it away from the same local
            ...
            <ol className="list-decimal space-y-1 pl-4">
              ...
              <li>Regenerate the QR code and scan it from the Serper mobile app.</li>
            </ol>
          </AccordionContent>
        </AccordionItem>
      </Accordion>
