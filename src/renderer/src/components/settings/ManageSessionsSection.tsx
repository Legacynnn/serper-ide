...
// keeps the Manage Sessions table visually consistent with how Serper labels
// the same worktrees in the bottom status bar ("serper/Anemone").
...
function formatWorkspace(session: { cwd: string | null; sessionId: string }): string {
  ...
  // revived sessions, older protocol versions). Serper's session IDs embed
