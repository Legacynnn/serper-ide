...
export function getAgentAwakeDescription(
  ...
  return 'Keeps this computer and display awake while agents are working. Serper also asks this device to stay awake when the lid is closed, subject to its power policy.'
}
