    ...
    <div className="space-y-6">
      ...
      {qrDataUrl && (
        <div className="flex flex-col items-center gap-3 rounded-lg border border-border/60 py-6">
          ...
          <p className="text-muted-foreground max-w-xs text-center text-xs">
            Scan this code with the Serper mobile app. Each code creates a unique device token.
          </p>
          {pairingUrl && (
      ...
      <div>
        ...
        {devices.length === 0 ? (
          <p className="text-muted-foreground text-sm">
            {qrDataUrl
              ? 'No devices paired yet. Scan the QR code with the Serper mobile app.'
      ...
      <div className="rounded-lg border border-border/60 p-4">
        ...
        <p className="text-muted-foreground mb-3 text-xs">
          While you&apos;re using a terminal on your phone, Serper shrinks it to fit your phone
      ...
      <Dialog open={qrEnlarged} onOpenChange={setQrEnlarged}>
        <DialogContent className="sm:max-w-sm">
          <DialogHeader>
            <DialogTitle>Scan with Serper Mobile</DialogTitle>
          </DialogHeader>
          {qrDataUrl && (
