...
// target_type narrows to the four shapes Serper renders meaningfully —
...
// tab so users can see which job failed and where without leaving Serper.
...
export type GitLabWorkItemDetails = {
   ...
   *  picker) — main-process doesn't know Serper's Repo.id. */
