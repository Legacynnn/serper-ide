...
export const BROWSER_ANNOTATION_VIEWPORT_MESSAGE_PREFIX = '__serper_annotation_viewport__:'
...
export function buildBrowserAnnotationViewportBridgeScript({
  ...
  const stateKey = '__serperBrowserAnnotationViewportBridge';
  const hostAttribute = 'data-serper-browser-annotation-overlay';
  const markerSize = 24;
