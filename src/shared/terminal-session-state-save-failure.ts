export const TERMINAL_SESSION_STATE_SAVE_FAILED_CODE = 'SERPER_TERMINAL_SESSION_STATE_SAVE_FAILED'

export const TERMINAL_SESSION_STATE_SAVE_FAILED_MESSAGE =
  'Serper could not save this terminal session because local storage is unavailable.'
