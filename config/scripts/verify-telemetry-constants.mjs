...
// Asserts that the telemetry compile-time constants — `SERPER_BUILD_IDENTITY`
// and `SERPER_POSTHOG_WRITE_KEY` — were substituted into the shipped binary.
...
function findAsar(rootDir) {
  ...
  // (`dist/mac/Serper.app/Contents/Resources/app.asar` for x64,
  // `dist/mac-arm64/Serper.app/Contents/Resources/app.asar` for arm64) because
...
// identifiers `SERPER_BUILD_IDENTITY` and `SERPER_POSTHOG_WRITE_KEY` with their
