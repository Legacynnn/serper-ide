    ...
    <View style={[styles.container, { paddingTop: insets.top + spacing.sm }]}>
      ...
      <View style={styles.section}>
        <Pressable
          ...
          onPress={() => void Linking.openURL('https://onSerper.dev')}
        >
          <Globe size={16} color={colors.textSecondary} />
          <Text style={styles.rowValue}>onSerper.dev</Text>
        </Pressable>
        <View style={styles.separator} />
        <Pressable
          style={({ pressed }) => [styles.row, pressed && styles.rowPressed]}
          onPress={() => void Linking.openURL('https://github.com/Legacynnn/serper')}
        >
          <GithubIcon />
          <Text style={styles.rowValue}>Legacynnn/serper</Text>
        </Pressable>
        <View style={styles.separator} />
        <Pressable
          style={({ pressed }) => [styles.row, pressed && styles.rowPressed]}
          onPress={() => void Linking.openURL('https://x.com/serper_build')}
        >
          <XIcon />
          <Text style={styles.rowValue}>@serper_build</Text>
        </Pressable>
      </View>
