...
const sections: TroubleshootSection[] = [
  ...
  },
  {
    ...
    steps: [
      'macOS: System Settings → Network → Firewall — allow Serper.',
      'Windows: Defender Firewall → Allow app — enable Serper for Private networks.',
  ...
  },
  {
    ...
    steps: [
      'Serper must be open on your desktop to accept connections.',
      'Try restarting Serper — the companion server starts on launch.',
