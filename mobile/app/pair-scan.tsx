...
export default function PairScanScreen() {
  ...
  const handleBarCodeScanned = useCallback(
    ({ data }: { data: string }) => {
      ...
      if (!offer) {
        setStatus('error')
        setErrorMessage('Not a valid Serper QR code')
      ...
      <View style={[styles.container, containerPadding]}>
        ...
        <View style={styles.centered}>
          ...
          <Text style={styles.subtitle}>
            {canAskAgain
              ? 'Scan the QR code from Serper on your desktop, or paste the pairing code instead.'
        ...
        <TextInputModal
          ...
          placeholder="serper://pair#... or paste the code"
  ...
  return (
    <View style={[styles.container, containerPadding]}>
      ...
      <View style={styles.steps}>
        <Step number={1} text="Open Serper on your computer" />
